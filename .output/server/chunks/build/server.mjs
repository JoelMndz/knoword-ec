import { hasInjectionContext, inject as inject$1, version as version$1, unref, readonly, toRaw, isRef, isReactive, toRef, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, createTextVNode, capitalize, h, defineComponent as defineComponent$1, shallowReactive, Suspense, getCurrentInstance as getCurrentInstance$1, camelize, TransitionGroup, Text, resolveDynamicComponent, markRaw, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, resolveComponent, render, useSSRContext, createApp, getCurrentScope, isVNode, Comment, onErrorCaptured, onServerPrefetch, defineAsyncComponent, isReadonly, withCtx, isShallow } from 'vue';
import { $ as $fetch$1, A as hasProtocol, B as isScriptProtocol, C as joinURL, D as withQuery, c as createError$1, b as defu, F as sanitizeStatusCode, G as createHooks, H as appendHeader, I as getRequestHeaders, J as getHeader, K as toRouteMatcher, L as createRouter$1, M as withoutTrailingSlash, N as withoutBase } from '../runtime.mjs';
...
const _routes = [
  {
    name: "app-estudiante-diccionario",
    path: "/app/estudiante/diccionario",
    component: () => import('./index-DFrjZZg7.mjs')
  },
  {
    name: "app-estudiante",
    path: "/app/estudiante",
    component: () => import('./index-DhKXjuWP.mjs')
  },
  {
    name: "app-estudiante-juego-id",
    path: "/app/estudiante/juego/:id()",
    component: () => import('./_id_-BA6uofXb.mjs')
  },
  {
  ...
  },
  {
    name: "app-profesor",
    path: "/app/profesor",
    component: () => import('./index-B-wY9nbH.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Sy6RZLqe.mjs')
  },
  {
    name: "registro",
    path: "/registro",
    component: () => import('./registro-DlF0xg7N.mjs')
  }
];
...
function makeCommonAuthState() {
  ...
  if (origin) {
    ...
    const determinedOrigin = getURL((_a2 = useRequestEvent()) == null ? void 0 : _a2.node.req, false);
...
const authMiddleware = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  ...
  if (((_a2 = authConfig.provider) == null ? void 0 : _a2.type) === "local") {
...
function getNitroRouteRules(path) {
  ...
  for (const match of matches) {
    options.disableServerSideAuth ?? (options.disableServerSideAuth = (_a2 = match.auth) == null ? void 0 : _a2.disableServerSideAuth);
  }
  return options;
}
class DefaultRefreshHandler {
  ...
  init() {
    ...
    if (enablePeriodically !== false) {
      ...
      this.refetchIntervalTimer = setInterval(() => {
        var _a3;
        if ((_a3 = this.auth) == null ? void 0 : _a3.data.value) {
          this.auth.refresh();
        }
      }, intervalTime);
    }
    const provider = this.runtimeConfig.provider;
    if (provider.type === "local" && provider.refresh.isEnabled && ((_a2 = provider.refresh.token) == null ? void 0 : _a2.maxAgeInSeconds)) {
      const intervalTime = provider.refresh.token.maxAgeInSeconds * 1e3;
      this.refreshTokenIntervalTimer = setInterval(() => {
        var _a3;
        if ((_a3 = this.auth) == null ? void 0 : _a3.refreshToken.value) {
          this.auth.refresh();
        }
      }, intervalTime);
    }
  ...
  visibilityHandler() {
    var _a2, _b;
    if (((_a2 = this.config) == null ? void 0 : _a2.enableOnWindowFocus) && (void 0).visibilityState === "visible" && ((_b = this.auth) == null ? void 0 : _b.data.value)) {
      this.auth.refresh();
    }
  }
}
...
const layouts = {
  default: () => import('./default-Bp17j29r.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CR-_rCKD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-lASzpI9E.mjs'));
...
export { VApp as V, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, resolveUnrefHeadInput as d, entry$1 as default, defineStore as e, useAuth as f, asyncDataDefaults as g, createError as h, injectHead as i, fetchDefaults as j, useRequestFetch as k, useRoute$1 as l, nuxtLinkDefaults as n, resolveRouteObject as r, storeToRefs as s, useRouter$1 as u };
